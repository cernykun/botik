...
await console.log("――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
await console.log("                                                                          ");
if(config.LicenseKey) await console.log(`${colors.green(colors.bold(`Plex Bot v${packageFile.version} is now Online!`))} (${colors.gray(`${config.LicenseKey.slice(0, -10)}`)})`);
if(!config.LicenseKey) await console.log(`${colors.green(colors.bold(`Plex Bot v${packageFile.version} is now Online!`))}`);
await console.log("                                                                          ");
await console.log(`• Join our discord server for support, ${colors.cyan(`discord.gg/dW9EpJk`)}`);
await console.log(`• By using this bot you agree to all terms located here, ${colors.yellow(`plexdevelopment.net/tos`)}`);
await console.log(`• Addons for the bot can be found here, ${colors.yellow(`plexdevelopment.net/store`)}`);
await console.log("                                                                          ");
await console.log(`• You can buy the full source code at ${colors.yellow(`plexdevelopment.net/store/psourcecode`)}`);
await console.log(`• Use code ${colors.green.bold.underline(`PLEX`)} for 10% OFF!`);
await console.log("                                                                          ");
await console.log("――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
